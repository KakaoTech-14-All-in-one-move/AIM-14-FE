...
import { ChannelContextType, Channels, ChannelType, User } from '@/components/Home/Channelbar/types';
...
export const ChannelProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const [activeChannels, setActiveChannels] = useState<Record<Exclude<ChannelType, 'text'>, Record<string, boolean>>>({
        voice: {},
        video: {},
    });
